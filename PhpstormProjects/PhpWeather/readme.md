...
If the API URL in `OpenWeatherApiService` is changed to a newer OpenWeather API version and a valid paid API key is provided, date-based weather retrieval will work correctly without further c